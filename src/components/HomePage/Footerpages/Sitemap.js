...
function SiteMap(params) {
    ...
    return (
        ...
        <div style={{ height: "100vh", marginTop: 100, marginLeft: 100, marginRight: 100 }}>
            <h1 style={{ color: "#004170", textAlign: "center" }}> SiteMap</h1>
            <h3>404 page not found</h3>
            <p>We are sorry but the page you are looking for does not exist.</p>
            About content of aUXtomate technologies and its vison and mission. In left side image is added
